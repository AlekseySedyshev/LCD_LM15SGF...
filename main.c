...
setLcdOn(ON);	
drawRect (0, 0, 101, 80, GREEN);//delay_ms(100);
fillRect (10, 10, 20, 10, YELLOW);//delay_ms(100);
fillRect (50, 10, 20, 10,BLUE);//delay_ms(100);


fillRect(10, 40, 50, 20, YELLOW);
LCD_Print("TEST", 10,40, PINK, WHITE,1,1,0);
LCD_PrintDec(counter, 10,50, PINK, WHITE,1,1,0);
LCD_PrintHex(counter, 10,60, GREEN, BLACK,1,1,0);
LCD_PrintBin(counter, 10,70, PINK, BLACK,1,1,0);

LCD_FillCircle (20, 30, 8, WHITE);
LCD_FillTriangle(65,40, 65, 60, 80,50, GREEN);

LCD_DrawTriangle(50,25, 50, 35, 80,30, WHITE);
//clear(BLACK);
//fillRect(0, 0, 101, 80, BLACK);
//LCD_Puts_Shadow("Hack reality", 3, 45,  RED, 1, 1, 0);	delay_ms(1000);
